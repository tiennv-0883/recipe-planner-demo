...
- TypeScript 5.x · React 18 · Next.js 14 (App Router) + Tailwind CSS v3 · next-intl 3.x · clsx · Playwright (e2e) (009-responsive-mobile-ui)
- N/A (layout-only; no schema changes) (009-responsive-mobile-ui)
...
## Recent Changes
- 009-responsive-mobile-ui: Added TypeScript 5.x · React 18 · Next.js 14 (App Router) + Tailwind CSS v3 · next-intl 3.x · clsx · Playwright (e2e)
